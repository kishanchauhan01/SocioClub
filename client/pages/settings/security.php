        ...
        <div class="row w-100 h-100 gap-0 m-0">
            ...
            <div class="col-md-10 col-12 h-md-100 p-4 d-flex justify-content-center align-items-center">
                <div class="settings-container">
                    ...
                    <form action="" class="text-white" id="form1">
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" id="email" name="emial" class="form-control" placeholder="Enter your email" value="kishanchauhan@rajkot.com">
                        </div>
